...
class _FalseTrashCapsuleState extends State<FalseTrashCapsule> {
  ...
  Widget _headerImage() {
    ...
    if (url != null && url.isNotEmpty) {
      return SquareHeaderImage(imageUrl: url, fallbackAsset: 'assets/images/features/false_capsule.png');
    }
  ...
  List<CapsuleItem> _fallbackItems(String waste, {required bool good}) {
    ...
    return [
      CapsuleItem(title: 'Lingkungan Rusak', description: '$w yang tercecer mencemari sungai, laut, dan tanah.', fallbackAsset: 'assets/images/features/false_capsule.png'),
      CapsuleItem(title: 'Udara Tercemar', description: 'Pembakaran $w menghasilkan asap berbahaya.', fallbackAsset: 'assets/images/features/false_capsule_2.png'),
      CapsuleItem(title: 'Sumber Habis', description: 'Produksi $w baru tanpa daur ulang menguras sumber daya alam.', fallbackAsset: 'assets/images/features/false_capsule_3.png'),
    ];
  }
