...
class _TrueTrashCapsuleState extends State<TrueTrashCapsule> {
  ...
  Widget _headerImage() {
    ...
    if (url != null && url.isNotEmpty) {
      return SquareHeaderImage(imageUrl: url, fallbackAsset: 'assets/images/features/true_capsule.png');
    }
    return Padding(
  ...
  List<CapsuleItem> _fallbackItems(String waste, {required bool good}) {
    ...
    return [
      CapsuleItem(title: 'Lingkungan Sehat', description: 'Pengelolaan $w yang benar menjaga sungai, laut, dan tanah tetap bersih.', fallbackAsset: 'assets/images/features/true_capsule.png'),
      CapsuleItem(title: 'Udara Bersih', description: 'Polusi berkurang karena $w tidak dibakar sembarangan.', fallbackAsset: 'assets/images/features/true_capsule_2.png'),
      CapsuleItem(title: 'Sumber Terjaga', description: 'Pemilahan & daur ulang $w membantu melestarikan sumber daya alam.', fallbackAsset: 'assets/images/features/true_capsule_3.png'),
    ];
  }
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: _loading
              ? const Center(child: Padding(padding: EdgeInsets.only(top: 48), child: CircularProgressIndicator(color: AppColors.fernGreen)))
              : SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      const Padding(
                        padding: EdgeInsets.symmetric(horizontal: 24.0),
                        child: Text('Penanganan sampah yang benar akan menjaga kelestarian bumi di masa depan.', style: TextStyle(fontSize: 14, color: Colors.black, fontFamily: 'Roboto')),
                      ),
          ...
          Expanded(
            child: btn(
              ...
              onTap: () {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => FalseTrashCapsule(cameras: cameras)));
              },
            ),
          ),
        ],
