...
import 'package:trashvisor/pages/login_and_register/login.dart' as auth;
...
class AppConstants {
  ...
  static const double heroHeightRatioSmall =
      0.40; // <<< untuk layar <700px tinggi
  ...
  static const double contentTopSpacing =
      2.0; // <<< jarak dari batas atas konten ke logo
      ...
      body: LayoutBuilder(
        builder: (context, _) {
          ...
          return Stack(
            children: [
              // ===================================================
              // LAYER 0: BACKGROUND (assets/images/bg/bg_login_regis.png)
              // ===================================================
              Positioned.fill(
                child: DecoratedBox(
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: const AssetImage(
                        'assets/images/bg/bg_login_regis.png',
                      ),
              ...
              // ===================================================
              // LAYER 1: ILUSTRASI PUZZLE (assets/images/login_and_register/puzzle_top.png)
              // ===================================================
              Positioned(
                left: 0,
                right: 0,
                ...
                height: heroHeight,
                child: Image.asset(
                  'assets/images/login_and_register/puzzle_top.png',
                  ...
                  child: Align(
                    ...
                    child: ConstrainedBox(
                      constraints: const BoxConstraints(
                        maxWidth:
                            AppConstants.contentMaxWidth, // <<< Ubah jika perlu
                      ),
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(
                              height: AppConstants.textButtonSpacing,
                            ),
...
class NavigationHelper {
  static Future<void> goToLogin(
    ...
    try {
      await precacheImage(
        const AssetImage('assets/images/login_and_register/login_top.png'),
        context,
      );
    } catch (_) {
      /* ignore */
  ...
  static Future<void> goToRegister(
    ...
    try {
      await precacheImage(
        const AssetImage('assets/images/login_and_register/register_top.png'),
        context,
      );
    } catch (_) {
      /* ignore */
    ...
    await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) =>
            reg.RegisterPage(cameras: cameras), // <<< langsung ke RegisterPage
